...
OUTPUT_FILE  = "../data/scan_result/scan_report_20251119_npm_only.json"
KEEP_WORKDIR = False
OFFICIAL_N8N_REPO = "https://github.com/n8n-io/n8n"
USER_AGENT   = "n8n-node-audit/3.0-npm-only"
try:
    import requests
except Exception:
...
def load_rows_from_csv(path: str) -> List[Dict[str, str]]:
    ...
    if "repository_url" not in df.columns:
        raise ValueError("CSV must have 'repository_url' column")
